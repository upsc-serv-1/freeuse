...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-[2rem] bg-white/50 backdrop-blur-2xl text-slate-950 shadow-[0_8px_32px_rgb(0,0,0,0.08)] border border-white/60 overflow-hidden",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <p
    ref={ref}
    className={cn("text-sm sm:text-base text-slate-500", className)}
    {...props}
  />
))
